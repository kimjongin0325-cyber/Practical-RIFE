...
MODEL_PATH = "/kaggle/working/Practical-RIFE/train_log/flownet.pkl"
OUTPUT_DIR = "/kaggle/working/Practical-RIFE/output"
...
'''
with open("/kaggle/working/Practical-RIFE/train_log/inference_img.py", "w") as f:
